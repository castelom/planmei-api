...
{
    /// <inheritdoc />
    public partial class InitialFinancialEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnualGoals", x => x.AnnualGoalId);
                    table.ForeignKey(
                        name: "FK_AnnualGoals_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlyGoals", x => x.GoalId);
                    table.ForeignKey(
                        name: "FK_MonthlyGoals_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "CompanyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyGoals_CompanyId",
                table: "MonthlyGoals",
                column: "CompanyId");
        }
